      ...
      <div className="grid grid-cols-4 gap-2">
        {[...'0123456789'].map(num => (
          <button 
            ...
            className="p-4 bg-gray-200 hover:bg-gray-300 text-xl rounded-lg"
          >
            {num}
          </button>
        ))}
        {['+', '-', '*', '/'].map(op => (
          <button 
            ...
            className="p-4 bg-blue-200 hover:bg-blue-300 text-xl rounded-lg"
          >
            {op}
          </button>
        ))}
        <button 
          ...
          className="p-4 bg-green-200 hover:bg-green-300 text-xl rounded-lg col-span-2"
        >
          =
        </button>
        <button 
          onClick={handleClear} 
          className="p-4 bg-red-200 hover:bg-red-300 text-xl rounded-lg col-span-2"
        >
          Clear
        </button>
      </div>
